...
exports.simpleAuthMiddleware = exports.adminAuthMiddleware = void 0;
function adminAuthMiddleware(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var auth_header, base64Credentials, credentials, _a, username, password;
        return __generator(this, function (_b) {
            try {
                auth_header = req.headers.authorization;
                if (!auth_header) {
                    return [2 /*return*/, res.status(401).json({ error: "No credentials provided." })];
                }
                ...
                base64Credentials = auth_header.split(" ")[1];
