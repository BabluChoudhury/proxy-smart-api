...
app.post("/api/v1/reseller/modem/:modem_id/settings",simpleAuthMiddleware,reseller_modem_setting)

app.post("/api/v1/reseller/modem/:modem_id/rotate",simpleAuthMiddleware,reseller_modem_rotate)

app.post("/api/v1/admin/reseller/:reseller_id/balance",adminAuthMiddleware,admin_reseller_balance)

app.get("/api/v1/admin/reseller/:reseller_id/modems",adminAuthMiddleware,admin_reseller_modem)
app.post("/api/v1/reseller/modem/:modem_id/whitelist",simpleAuthMiddleware,reseller_modem_whitelist)
